...
export default function ITSCRegisterModal() {
    ...
    const submit = (event: FormEvent<HTMLFormElement>) => {
        ...
        console.info(
            "ITSC static registration submitted",
                ...
                <div className="mt-6 text-center sm:mt-10">
                    ...
                    <div className="mb-8 flex flex-col items-center justify-center gap-4 sm:mb-12 sm:flex-row sm:gap-16 md:gap-24">
                        {(["individual", "team"] as const).map((type) => (
                            <label
                                key={type}
                                className="flex cursor-pointer items-center gap-2.5 capitalize"
                            >
                                <input
                                    type="radio"
                        ...
                        <div className="mt-6 space-y-4">
                            {teamMembers.map((memberId, index) => (
                                ...
                                >
                                    ...
                                    <MemberFields
                                        namePrefix={`team_member_${memberId}_`}
                                    />
                                </div>
                            ))}

    ...
    return (
        <section className="mx-auto max-w-[1500px] px-2 py-6 sm:p-8">
            ...
            <h1 className="mt-10 text-center text-3xl font-bold">
                Download Chapter I of BE GREEN HEROES for free
            </h1>
            <h2 className="mt-4 text-center text-2xl">
                Different Language Versions
            </h2>
            <div className="my-8 grid gap-7 sm:grid-cols-2 xl:grid-cols-3">
                {languageDocuments.map(([language, image, file]) => (
                    <article
                        key={language}
            ...
            <p className="text-center italic text-blue">
                * Other language versions will be made available at a later date
            </p>
            <Link
                to="/learn"
                className="mt-6 inline-block rounded-lg bg-blue px-5 py-2.5 font-semibold text-white"
            >
                Previous
            </Link>
            ...
            >
                ...
                <form onSubmit={submit} className="space-y-4 p-4 sm:p-6">
                    ...
                    <p className="flex gap-2 rounded-xl bg-light-muted p-4 text-sm text-navy">
                        <FaLock className="mt-1 shrink-0" /> Your information is

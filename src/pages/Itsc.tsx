  ...
  return (
    <section className="text-center">
      <div className="mx-auto max-w-[1500px] px-2 py-5 sm:p-8">
        ...
        <h1 className="text-[clamp(2rem,4vw,4rem)] font-bold">International True Sustainability Competition (ITSC) 2026</h1>
        <h2 className="mt-3 text-[clamp(1.5rem,3vw,3rem)] font-semibold text-dull-green">Uniting Visionaries for Environmental Stewardship</h2>
